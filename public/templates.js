...
buf.push("<h2>Thing<small> " + (jade.escape((jade_interp = thing.guid) == null ? '' : jade_interp)) + "</small></h2><form><p><label>Name<br/><input type=\"text\" name=\"name\"" + (jade.attr("value", thing.name, true, false)) + " required=\"required\"/></label></p><p><label>Description<br/><textarea name=\"description\">" + (jade.escape(null == (jade_interp = thing.description) ? "" : jade_interp)) + "</textarea></label></p><p><button type=\"submit\">Save</button></p></form>");}.call(this,"thing" in locals_for_with?locals_for_with.thing:typeof thing!=="undefined"?thing:undefined));;return buf.join("");
};
